...
import pl.cuyer.rusthub.data.local.mapper.toItemSummary
...
class GetPagedItemsUseCase(
    ...
    /**
     * Invokes the use case to retrieve a paginated flow of `ItemSummary` objects.
     *
     ...
     * @return A `Flow` emitting paginated data of `ItemSummary` objects.
     */
    ...
    operator fun invoke(
        ...
        return Pager(
            ...
            pagingData.map { it.toItemSummary() }
        }
    }
}